...
//Excepcion que se lanza cuando se trata de crear
    ...
    //**** COMPLETAR
    Racional suma(Racional arg);
    Racional operator -(Racional arg);
    void divideYActualiza(Racional arg);
    void operator *=(Racional arg);
...
private:
    ...
    // el denominador es siempre positivo, y el unico divisor comun del numerador y el denominador es 1)
